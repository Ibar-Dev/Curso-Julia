...
- [Galería de notebooks Pluto.jl](https://plutojl.org/en/docs/sample-notebooks/)
...
- Practica regularmente y experimenta con ejemplos propios
- Consulta la documentación y participa en la comunidad
